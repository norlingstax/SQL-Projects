...
There are a total of 29009 rows and 9 columns in the bikesales table, which is the database for this analysis.
...
Column Analysis:
1. id: There are 29009 unique rows.
2. price: The number of rows is 29009, as expected. Prices range from 1 to 1,111,111.
3. mileage: There are 29009 rows with valus from 0 to 1,085,820. No null values.
4. power: There are 23606 values in this column ranging from 1 to 1358.
5. make_model: There are 29009 rows with 2161 unique values.
6. year: As expected, there are 29009 rows with years from 1907 to 2022.
7. fuel: There are 26239 values in the column. Types of fuel: Gasoline, Two Stroke Gasoline, Electric, Diesel, Electric/Gasoline, LPG, Others.
8. gear: There are 10755 values. Types of gear: Manual, Automatic, Semi-automatic.
